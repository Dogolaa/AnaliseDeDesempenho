...
int main(void){
    ...
    printf("---=== Iniciando Bateria de Simulacoes (Politica FCFS Global) ===---\n");
    ...
    for (int run = 0; run < NUM_RUNS; run++) {
        ...
        sprintf(nome_arquivo, "relatorio_fcfs_ocupacao_%s_pct.csv", rho_label);
        ...
        /*
         * ===================================================================
         * Bloco 3: MOTOR DE EVENTOS (lógica original do FCFS)
         * ===================================================================
         */
        while(tempo_decorrido < tempo_simulacao){
            ...
            /*
             * ===================================================================
             * Bloco 4: PROCESSAMENTO DE EVENTOS (lógica original do FCFS)
             * ===================================================================
             */
